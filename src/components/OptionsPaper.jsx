    ...
    <Paper className="Paper" elevation={0} sx={{ borderRadius: "20px" }}>
      <Box p={2}>
        <Stack direction="column" spacing={2} alignItems="center">
          <FormControl>
            <FormLabel
              color="customFormLabel"
              id="generate-schedules-radio-buttons-group-label"
            >
              Schedule Options
            </FormLabel>
            <RadioGroup
            ...
            >
              <FormControlLabel
                color="customRadioButtons"
                sx={{ height: H_SPACING }}
                control={
                  <Radio
                    value="most compact"
                    onChange={(e) =>
                      switchRecommendation(e, Recommended.compact)
                    }
                  />
                }
                label="most compact"
              ...
              <FormControlLabel
                ...
                control={
                  <Radio
                    value="most scattered"
                    onChange={(e) =>
                      switchRecommendation(e, Recommended.scattered)
                    }
                  />
                }
              ...
              <FormControlLabel
                ...
                control={
                  <Radio
                    ...
                    onChange={(e) =>
                      switchRecommendation(e, Recommended.consistent)
                    }
                  />
                }
              ...
              <FormControlLabel
                ...
                control={
                  <Radio
                    value="most free days"
                    onChange={(e) =>
                      switchRecommendation(e, Recommended.freeDays)
                    }
                  />
                }
