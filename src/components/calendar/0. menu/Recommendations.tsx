      ...
      >
        <Tooltip title="Most Compact">
          <ToggleButton
            value="compact"
            size="small"
            aria-label="Most Compact"
            onClick={() => switchRecommendation(Recommended.compact)}
            disabled={prevent}
          >
        ...
        <Tooltip title="Most Scattered">
          <ToggleButton
            value="scattered"
            size="small"
            aria-label="Most Scattered"
            onClick={() => switchRecommendation(Recommended.scattered)}
            disabled={prevent}
          >
        ...
        <Tooltip title="Most Consistently Starting">
          <ToggleButton
            value="consistent"
            size="small"
            aria-label="Most Consistent"
            onClick={() => switchRecommendation(Recommended.consistent)}
            disabled={prevent}
          >
        ...
        <Tooltip title="Most Free days">
          <ToggleButton
            value="freedays"
            size="small"
            aria-label="Most Free Days"
            onClick={() => switchRecommendation(Recommended.freeDays)}
            disabled={prevent}
          >
